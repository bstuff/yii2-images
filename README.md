...
1. Add Yii2-user to the require section of your composer.json file:
    <pre>
       {
            "require": {
                "costa-bstuff/yii2-images": "dev-master"
            }
       }
    </pre>
2. run 
...
3. run migrate
    <pre>
    php yii migrate/up --migrationPath=@vendor/costa-bstuff/yii2-images/migrations
    </pre>
...
5. attach behaviour to your model (be sure that your model has "id" property)
    ```php
        public function behaviors()
        {
            return [
                'image' => [
                    'class' => 'bstuff\yii2images\behaviors\ImageBehave',
                ]
            ];
        }
    ```

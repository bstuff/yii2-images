...
use bstuff\yii2images\behaviors\ImageBehave;
...
class ImageTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $config = ArrayHelper::merge(require(Yii::getAlias($this->appConfig)), [
            ...
            'modules' => [
                'bstuffStore' => [
                    'class' => 'bstuff\yii2images\Module',
        ...
        $module = Yii::$app->getModule('bstuffStore');
    ...
    public function testGetUrl()
    {
        ...
        $baseUrl = '/app/web/index-test.php/bstuffStore/images/image-by-item-and-alias?item=ActiveRecordImage1&dirtyAlias=';
